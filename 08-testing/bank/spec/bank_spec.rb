...
describe Bank do
  ...
  describe '#create_account' do
    it 'creates an a new account' do
      bank.create_account( 'Homer', 200 )
      expect(bank.accounts['Homer']).to eq 200
    end
    it 'ignores opening balabce of less than or equal to 0' do
  ...
  describe '#withdraw' do
    ...
    it 'ignores the request for withdrawals greater than the account balance' do
...
#check if someone withdraw a negative amount
#check if someone deposits a negative amount
